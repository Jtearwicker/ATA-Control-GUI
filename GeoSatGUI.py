...
def go_to_GOES17_clicked():
    # Slew to azimuth and elevation for XM-4
    ac.track_source(antennas, azel=[203.0, 40.0])
    terminal_text.insert(0.0, "Slewing to GOES-17 (Azimuth: 203, Elevation: 40).\n")

def go_away_from_GOES17_clicked():
    # Slew to azimuth and elevation away from XM-4
    ac.track_source(antennas, azel=[203.0, 62.0])
    terminal_text.insert(0.0, "Slewing away from GOES-17 (Azimuth: 203, Elevation: 62.0).\n")
...
GOES17_button = customtkinter.CTkButton(
    control_frame, width=150, height=40, text="Go To GOES-17", font=("Arial", 16), command=go_to_GOES17_clicked
)
GOES17_button.pack(side=LEFT, padx=5, pady=5)

away_from_GOES17_button = customtkinter.CTkButton(
    control_frame, width=150, height=40, text="Go Away From GOES-17", font=("Arial", 16), command=go_away_from_GOES17_clicked
)
away_from_GOES17_button.pack(side=LEFT, padx=5, pady=5)
