...
root.geometry("800x600")  # Smaller window size
...
antennas = ['1a']
freq = "2340"  # Updated frequency for geostationary satellites
...
def activate_antenna_clicked():
    ...
    if ant_free.find('1a') == -1:
        ...
        terminal_text.insert(0.0, "Frequency set to 2340 MHz and autotuned.\n")
...
xm4_button = customtkinter.CTkButton(
