...
gl_max_entry = customtkinter.CTkEntry(master=control_frame, placeholder_text="GL Max")
gl_max_entry.pack(padx=5, pady=5)

gl_obs_entry = customtkinter.CTkEntry(master=control_frame, placeholder_text="GL Obs")
