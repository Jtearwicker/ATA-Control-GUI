...
OBSERVATION_PROFILES = {
    "Custom": None,
    "21cm Hydrogen Line": 1420.405e6,
    "Tianwen-1 Mars Orbiter": 8431.0e6,
}
...
def ata_track_altaz(alt_str, az_str):
    """
    Track fixed Alt/Az given as strings in degrees, e.g. '35.0', '270.0'.

    Uses ac.track_source(antennas, azel=[az_deg, alt_deg])
    """
    alt_deg = float(alt_str)
    az_deg = float(az_str)

    # ATA expects azel=[azimuth_deg, elevation_deg]
    ac.track_source(antennas, azel=[az_deg, alt_deg])
