...
original_img = img.copy()  # Save unmodified copy
...
clear_drawing_button = customtkinter.CTkButton(master=control_frame, width=200, height=50, text="Clear Drawing", font=("Arial", 18), command=clear_drawings)
clear_drawing_button.pack(padx=5, pady=5)
